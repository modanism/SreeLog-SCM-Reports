...
where BJS.IsDeleted = 0 and co.Code = 'JKTUAT'
and bcc.Name like 'OCEAN FREIGHT%'

Select  BookingProcessId,Cast('' as varchar(120)) as ProcessNumber,Cast('' as varchar(120)) as BookingNo, Cast('' as varchar(120)) as Carrier,Cast('' as varchar(120)) as POL, Cast('' as varchar(120)) as POD,Cast('' as varchar(120)) as Customer,Cast(0 as int) as [20],Cast(0 as int) as [40],Cast(0 as int) as [Other],
...
Select BookingProcessId,BookingNo, ProcessNumber,Carrier,POL, POD,Customer,[20],[40],[Other],
...
from #CarrierDetails group by BookingProcessId, Carrier,POL, POD,Customer,BookingNo, ProcessNumber,
partyName,chargecode,chargeName,[20],[40],[Other]
